...
import dev.babananick.pap.core.domain.PersonalTestInteractor
...
class TestScreenViewModel @AssistedInject constructor(
    ...
    fun proceedTest(test: dev.babananick.pap.core.model.tests.Test): Boolean {
    ...
    fun navigateToFirstSkipped(test: dev.babananick.pap.core.model.tests.Test): dev.babananick.pap.core.model.questions.Question {
    ...
    private fun isAllQuestionsAnswered(test: dev.babananick.pap.core.model.tests.Test): Boolean{
        test.questions!!.forEach {question ->
            if (!question.isAnswered){
                return false
            }
